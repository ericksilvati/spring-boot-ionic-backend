...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Categoria cat7 = new Categoria(null, "Pesca");
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "efsgarbage@gmail.com", "36378912377", TipoCliente.PESSOAFISICA);
		cli1.getTelefones().addAll(Arrays.asList("27163323", "93838393"));
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "58220034", cli1, c1);
		...
		Date instante1 = sdf.parse("30/09/2017 18:32");
		Date instante2 = sdf.parse("10/10/2017 19:352");
